...
function generate_hrp2jsknt_model()
{
 # force sensors
    ...
    tmp_model2=`add_sensor_to_tmp_urdf 0 0 -0.077 0 0 0 LARM_LINK6 lhsensor $tmp_model1`
...
# camera
    echo Adding head
    tmp_model5=$(add_sensor_to_tmp_urdf 0.093 0.017 0.131 -1.787 0.038 -1.576 HEAD_LINK1 CARMINE $tmp_model4)
