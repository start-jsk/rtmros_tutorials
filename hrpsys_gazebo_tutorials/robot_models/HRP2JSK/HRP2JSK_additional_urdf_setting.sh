...
sed -i -e '/<collision>/{N;N;N;s@<collision>\n      <origin xyz="0 0 0" rpy="0 -0 0"/>\n      <geometry>\n        <mesh filename="package://hrpsys_gazebo_tutorials/robot_models/HRP2JSK/meshes/RLEG_LINK5_mesh.dae" scale="1 1 1" />@<collision>\n      <origin xyz="0.015 -0.010 -0.08" rpy="0 -0 0"/>\n      <geometry>\n        <box size="0.240 0.138 0.07"/>@;}' ${OUTPUT_FILE}
sed -i -e '/<collision>/{N;N;N;s@<collision>\n      <origin xyz="0 0 0" rpy="0 -0 0"/>\n      <geometry>\n        <mesh filename="package://hrpsys_gazebo_tutorials/robot_models/HRP2JSK/meshes/LLEG_LINK5_mesh.dae" scale="1 1 1" />@<collision>\n      <origin xyz="0.015 0.010 -0.08" rpy="0 -0 0"/>\n      <geometry>\n        <box size="0.240 0.138 0.07"/>@;}' ${OUTPUT_FILE}
