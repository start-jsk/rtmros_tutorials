...
sed -i -e '/<collision>/{N;N;N;s@<collision>\n      <origin xyz="0 0 -0.04" rpy="0 -0 0"/>\n      <geometry>\n        <mesh filename="package://hrpsys_gazebo_tutorials/robot_models/JAXON/meshes/RLEG_LINK5_mesh.dae" scale="1 1 1" />@<collision>\n      <origin xyz="0.015 -0.010 -0.071" rpy="0 -0 0"/>\n      <geometry>\n        <box size="0.23 0.13 0.05" />@;}' ${OUTPUT_FILE}
sed -i -e '/<collision>/{N;N;N;s@<collision>\n      <origin xyz="0 0 -0.04" rpy="0 -0 0"/>\n      <geometry>\n        <mesh filename="package://hrpsys_gazebo_tutorials/robot_models/JAXON/meshes/LLEG_LINK5_mesh.dae" scale="1 1 1" />@<collision>\n      <origin xyz="0.015 0.010 -0.071" rpy="0 -0 0"/>\n      <geometry>\n        <box size="0.23 0.13 0.05" />@;}' ${OUTPUT_FILE}
